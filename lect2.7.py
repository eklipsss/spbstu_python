...
births = pd.read_csv('./lectures/data/births-1969.csv')
...
fig = plt.figure(facecolor='gray')  # Серый фон фигуры
...
# matplotlibrc - специальный файл, в котором можно сохранить настройки
# графиков и дальше к ним обращаться
